...
func TestAboutHealthReadinessAndRequestHeaders(t *testing.T) {
	...
	for _, expected := range []string{"From release to incident", "Publish in German", "Check and translate in the background", "Accuracy and official information", "Privacy and data handling", "Independence and legal review", "Contact", `href="https://github.com/egekocabas/munichbrief/issues"`, `href="mailto:contact@munichbrief.de"`} {
