...
func TestAdminTranslationOperationsOverviewDrilldownsAndActions(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"English", "1 / 1", "100%", "Manage", "Preferred route", "Structured chat (general LLM)", "HY-MT2 native", "Seed-X native", "SalamandraTA native", "Attention can overlap published", "1 retained replacement warning", "data-translation-operations",
