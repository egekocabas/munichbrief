ALTER TABLE translation_language_settings RENAME TO translation_language_settings_before_salamandrata;
...
CREATE TABLE translation_language_settings (
    ...
    adapter_key TEXT NOT NULL DEFAULT 'structured'
        CHECK (adapter_key IN ('structured', 'translategemma', 'hy-mt2', 'seed-x', 'salamandra-ta')),
...
FROM translation_language_settings_before_salamandrata;

DROP TABLE translation_language_settings_before_salamandrata;
