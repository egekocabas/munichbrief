ALTER TABLE translation_language_settings RENAME TO translation_language_settings_before_madlad400_gemma4;
...
CREATE TABLE translation_language_settings (
    ...
    adapter_key TEXT NOT NULL DEFAULT 'structured'
        CHECK (adapter_key IN ('structured', 'translategemma', 'hy-mt2', 'seed-x', 'salamandra-ta', 'llamax3', 'eurollm', 'tower-plus', 'tower-instruct', 'madlad400', 'gemma4')),
...
FROM translation_language_settings_before_madlad400_gemma4;

DROP TABLE translation_language_settings_before_madlad400_gemma4;
