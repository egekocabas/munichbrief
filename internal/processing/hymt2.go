...
var hyMT2LanguageGuidance = map[string]string{
	...
	"uk": "Preserve reported allegations without turning them into obligations or established facts. In news reporting, German ‘soll … haben’ reports an alleged action; use unambiguous Ukrainian wording such as ‘за повідомленнями, …’ or ‘як стверджується, …’, never ‘мав …’, which can mean that someone was supposed or required to act. Use exact Ukrainian legal terms: ‘Verurteilung’ means ‘засудження’, and ‘rechtskräftige Verurteilung’ means ‘остаточне засудження’ or ‘набрання законної сили обвинувальним вироком’, never merely ‘вирок’ or ‘остаточне рішення’, because a verdict or decision may be an acquittal. Translate ‘Unschuldsvermutung’ as ‘презумпція невинуватості’. Keep ordinary police questioning neutral: translate ‘befragen’ as ‘опитувати’, never ‘допитувати’ unless the source explicitly describes an interrogation. Preserve street-location precision: German ‘an der … Straße’ means on/at the street (‘на вулиці’), not merely near it (‘біля вулиці’).",
}
