...
var (
	...
	towerPlusLanguageGuidance = map[string]string{
		...
		"ru": "Use natural standard Russian. Preserve evidential and legal modality: German 'soll ... haben' reports an allegation and must remain explicitly alleged, never established fact. Preserve approximate times with wording such as около. Translate 'Polizeieinsatz' neutrally as полицейская операция or действия полиции, never as рейд or захват. Preserve negation, legal status, subject, object, and causality.",
	}
