...
var (
	llamax3LanguageGuidance = map[string]string{
		...
		"hr": "Use natural standard Croatian, not Bosnian or Serbian variants, and translate police and investigation terms accurately. Preserve grammatical subject and object, cause and effect, allegations, negation, and each certainty level. A stated absence of a conviction must remain definite, not become uncertainty; distinguish exact times from approximate times such as German 'gegen', and preserve which transit service was delayed or unaffected.",
