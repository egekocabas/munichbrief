...
var (
	...
	gemma4LanguageGuidance = map[string]string{
		"bs": "Use natural standard Bosnian. Preserve evidential and legal modality: German 'soll ... haben' reports an allegation and must use wording such as 'navodno' or 'sumnjiči se', never an established fact. Translate Tatverdächtiger as osumnjičeni, never optuženi, unless the source says the person was formally accused. Keep a medical examination distinct from treatment or aid and preserve whether a time is approximate, using oko where appropriate.",
		"el": "Use only natural standard Greek without words or characters from another script. Preserve evidential and legal modality: German 'soll ... haben' reports an allegation and should use wording such as 'φέρεται να', never an established fact. Translate Unschuldsvermutung as τεκμήριο αθωότητας. Keep a medical examination distinct from treatment or aid.",
		"hi": "Use only natural standard Hindi in Devanagari. Preserve evidential and legal modality: German 'soll ... haben' reports an allegation and should use wording such as 'पर ... का आरोप है' or 'कथित तौर पर', never an established fact. Keep a medical examination distinct from treatment or aid. Preserve whether a time is approximate, using लगभग or करीब where appropriate.",
		"hr": "Use only natural standard Croatian. Preserve evidential and legal modality: German 'soll ... haben' reports an allegation and must use wording such as 'navodno', never an established fact. Translate Tatverdächtiger as osumnjičenik, never optuženi, unless the source says the person was formally accused. Keep a medical examination distinct from treatment or aid and preserve whether a time is approximate, using oko where appropriate.",
