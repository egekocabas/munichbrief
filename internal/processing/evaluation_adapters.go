...
var (
	llamax3LanguageGuidance = map[string]string{
		...
		"hi": "Use concise, natural standard Hindi in Devanagari, with headlines no longer than 90 characters after placeholders are restored. Preserve every source sentence and all legal qualifiers. Render German reported allegations such as 'soll ... haben' explicitly with Hindi allegation wording such as 'पर ... करने का आरोप है' or 'बताया गया है कि', never as established fact. Keep subject, object, cause, referent gender, negation, and uncertainty unchanged; use feminine grammar for a woman. Translate a vehicle's Scheibe as 'वाहन की खिड़की' or 'शीशा', never spectacles, and render paired witness gender forms once as 'गवाहों'.",
	}
